...
import { openDiffInEditor } from '../cli-support/editor.js';
import { writeCompareEditorArtifacts } from '../cli-support/editor-artifacts.js';
...
import { resolveEditor } from '../types.js';
